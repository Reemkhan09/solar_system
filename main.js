...
const textures = [ `${import.meta.env.BASE_URL}2_no_clouds_16k.jpeg`,
  `${import.meta.env.BASE_URL}2k_mars.jpg`,
  `${import.meta.env.BASE_URL}mercurytex.avif`,
  `${import.meta.env.BASE_URL}jupi_2.avif`];

const spheres = new THREE.Group();

// Create a large sphere with a stars texture

const starTexture = new THREE.TextureLoader().load(`${import.meta.env.BASE_URL}stars.jpg`);
